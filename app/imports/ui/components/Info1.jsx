        ...
        <div className='landing-info1'>
          ...
          <Grid className='landing-info1-title'>
            <Grid.Row columns={3} divided={true}>
              ...
              <Grid.Column textAlign='center'>
                  <Icon size='huge' name='leaf' color='green' style={{ cursor: 'pointer' }} onClick={this.handleOnClick.bind(this)}/>
                  <Header as='h2' textAlign='center' style={{ cursor: 'pointer' }} onClick={this.handleOnClick.bind(this)}>
